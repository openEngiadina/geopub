...
(define-public ocaml-xmppl
  (package
    (name "ocaml-xmppl")
    (version "18efce9cee9c2a8c495798044b7976d5feed4544")
    ...
    (source
     (origin (method git-fetch)
             ...
             (file-name (git-file-name name version))
             (sha256
              (base32 "028b38dnsn4fzy4xgbfysa1l7kkj6mygsjlms05llm4yqmzl98z8"))))
    ;; (arguments `(#:tests? #f))
    (build-system dune-build-system)
    (native-inputs
     `(("alcotest" ,ocaml-alcotest)
...
(define-public ocaml-datalogl
  (package
    (name "ocaml-datalogl")
    (version "b5f5a8e37c42dfe16d5934b677b2e895fc3bb6ba")
    ...
    (source
     (origin (method git-fetch)
             ...
             (file-name (git-file-name name version))
             (sha256
              (base32 "1771b06sdxs1v3anbhvc7b0r32irbpahy4z65d2ndb5v7jgr79hi"))))
    (build-system dune-build-system)
    (arguments '())
    (propagated-inputs
     (list ocaml-fmt
